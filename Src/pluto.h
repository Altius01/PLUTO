...
#define SUPER_TIME_STEPPING                                                    \
  2 /* -- just a number different from EXPLICIT --                             \
     */
...
#define MAX_OUTPUT_TYPES                                                       \
  16 /* The max number of allowed data formats                                 \
        including fluid and particles */
#define MAX_OUTPUT_VARS                                                        \
  64 /* The maximum nuber of variables that can be                             \
...
#define FLAG_SPLIT_CELL                                                        \
  16 /**< Zone is covered by a finer level                                     \
         (AMR only). */
#define FLAG_INTERNAL_BOUNDARY                                                 \
  32 /**< Zone belongs to an internal boundary                                 \
...
#define FLAG_GCA_FAILURE                                                       \
  32768 /**< Singularity in the GCA because of                                 \
...
#define GPLUTO_LOG                                                             \
  NO /* Log file in the style of gPLUTOO (for comparison purposes) */
#endif
...
#define INITIAL_SMOOTHING                                                      \
  NO /**< Assign initial conditions by averaging                               \
...
#ifndef NGHOST_USR
#define NGHOST_USR                                                             \
  -1 /**< When positive, it specifes a                                         \
          user-provided number of ghost zones. */
#endif

#ifndef QUIT_ON_FIX
#define QUIT_ON_FIX                                                            \
  NO /**< When set to YES, quit execution when                                 \
...
#define RECONSTRUCT_4VEL                                                       \
  NO /**< When set to YES, reconstruct 4-velocity                              \
...
#define He_MASS_FRAC                                                           \
  (1 - H_MASS_FRAC) /* Effective Y and not 0.2741                              \
                       Baraffe (2008) */
#elif COOLING == SNEq
